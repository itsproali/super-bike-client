...
const ManageInventory = () => {
  ...
  return (
    <div className="my-16 mx-3 md:mx-8 lg:mx-12">
      <h1 className="text-xl font-semibold text-red-600">Total Found: { items.length} Bikes</h1>
    <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
      ...
      <div className="w-full bg-white shadow-lg h-96 md:col-span-2 lg:col-span-2 flex items-center justify-center">
        {/* <form>
          ...
          <button className="py-2 px-4 bg-blue-500 hover:bg-blue-700 text-center duration-500 text-white rounded flex items-center">
            <MdPlaylistAdd></MdPlaylistAdd>
            <p className="ml-1">Add New Item</p></button>
      </div>
    </div>
    </div>
  );
